<x-app-layout>
    ...
    <div class="card">
        <div class="card-header bg-white fw-bold d-flex justify-content-between align-items-center">
            ...
            <a href="{{ secure_url('log-viewer') }}" target="_blank" class="btn btn-sm btn-outline-primary">
                <i class="fa-solid fa-up-right-from-square"></i> Buka Penuh
            </a>
        </div>
        <div class="card-body p-0">
            <iframe src="{{ secure_url('log-viewer') }}" style="width: 100%; height: 600px; border: none; border-bottom-left-radius: 0.5rem; border-bottom-right-radius: 0.5rem;"></iframe>
        </div>
    </div>

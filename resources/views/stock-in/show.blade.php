                ...
                <div class="card-body">
                    @if($stockIn->receipt_path)
                        ...
                        @if(in_array(strtolower($ext), ['jpg','jpeg','png']))
                            <img src="{{ asset('storage/' . $stockIn->receipt_path) }}" class="img-fluid rounded mb-3" alt="Bukti Kwitansi">
                        @else
                            <div class="d-flex align-items-center mb-3 p-3 bg-light rounded">
                                <i class="bi bi-file-earmark-pdf fs-1 text-danger me-3"></i>
                                <div>
                                    <div class="fw-semibold">File PDF</div>
                                    <a href="{{ asset('storage/' . $stockIn->receipt_path) }}" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
